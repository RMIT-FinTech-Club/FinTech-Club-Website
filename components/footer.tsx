...
const Footer = () => {
	return (
		<footer className="md:h-fit w-full bg-ft-primary-blue flex flex-col justify-center z-30 items-center">
			<div className="mx-auto md:w-[90%] h-fit mt-[62px] mb-[20px] flex flex-col md:flex-row justify-center">
				...
				<div className="md:w-1/3 w-full mb-[40px] md:mb-0 flex justify-center md:justify-end">
					<div className="mt-[20px] w-fit flex items-center flex-col md:block">
						<h5 className="ft-heading-1 text-ft-text-bright w-fit mb-4">
							Contact Info
						</h5>
