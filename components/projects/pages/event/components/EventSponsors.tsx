...
const EventSponsors: React.FC<EventSponsorsProps> = ({ sectionValue }) => {
    ...
    return (
        ...
        >
            <div className="text-gold text-[5vw] md:text-[1vw] text-center">Our Sponsors</div>
            <div className=" text-deepBlue text-[7.5vw] md:text-[3vw] text-center font-bold uppercase tracking-[0.2vw] md:tracking-[0.1vw]">Event <span className="text-gold">Sponsors</span></div>
