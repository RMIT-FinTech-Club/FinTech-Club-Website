	...
	return (
		...
		>
			...
			<div className="flex justify-center items-center flex-col w-[90vw]">
				...
				<div
					ref={more1Ref}
					className="md:flex hidden md:flex-row flex-col justify-center items-center w-full md:my-[1vw] my-[2vh]"
				>
					{renderImages(3)}
				</div>
				<div
					ref={more2Ref}
					className="md:flex hidden md:flex-row flex-col justify-center items-center w-full"
				>
					{renderImages(6)}
				</div>
				<span ref={btnRef}>
					<Button
						onClick={loadMore}
						classes="md:hidden inline-block mt-[2vh]"
					>
						Load More
					</Button>
				</span>
