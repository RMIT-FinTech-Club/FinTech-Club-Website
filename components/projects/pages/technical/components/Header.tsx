...
const Header: React.FC<HeaderProps> = ({ introduce }) => {
	...
	return (
		<section className='min-h-[100vh] flex md:flex-row flex-col-reverse flex-wrap md:flex-nowrap overflow-x-hidden md:p-[5vw] px-[5vw] py-[10vw] relative bg-deepBlue'>
			<Decor1 />
			...
			<div className={`${flexCenter} items-center md:items-start flex-col w-full md:w-1/2 z-10`}>
				...
				<div className='md:my-[2vh] my-[1vh] text-white text-[7vw] md:text-[4vw] font-bold tracking-[0.2vw] text-nowrap'>Technical Projects</div>
