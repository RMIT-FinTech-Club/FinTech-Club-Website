		...
		<nav>
			{isMobile ? (
				<div className="content mr-[8.5vw] ml-auto">
					<div className="bg-[linear-gradient(90deg,_#C9D6EA_10px,_#FFEFCA)] ml-32 w-[60vw] md:w-[72vh] h-[87vh] rounded-[2vw] p-[1vw]">
						<div className="w-full md:w-[70vh] h-[85vh] rounded-[1vw] bg-white flex justify-center items-center">
							<div className="w-full h-full flex flex-col items-center justify-start relative">
								...
								<div
									className={`flex-1 flex items-center justify-center w-[40vh] md:w-[75vh] max-h-[65vh] px-[4rem] py-[1rem] pb-0 ${
										gridCols.includes("grid")
											? `grid ${gridCols} gap-2 place-items-center md:grid-cols-4 lg:${gridCols}`
									...
									{partners.map((partner, index) => {
										...
										return (
											<Image
												...
												src={partner.url}
												alt={partner.alt}
												className={`${imageHeight} md:w-[30vh] w-[500px] object-contain`}
												width={400}
												height={400}
												fetchPriority="high"
												loading="eager"
					...
					<div className="bg-[linear-gradient(90deg,_#C9D6EA_10px,_#FFEFCA)] w-[70vw] h-[88vh] rounded-[2vw] p-[1vw]">
						<div className="w-full h-full rounded-[1vw] bg-white flex justify-center items-center">
							<div className="w-full h-full flex flex-col items-center justify-start relative">
								...
								<div
									className={`flex-1 flex items-center justify-center ma-h-[65vh] px-[4rem] py-[1rem] pb-0 ${
										gridCols.includes("grid")
