                        ...
                        return (
                            <Button
                                className={clsx("text-white",
                                    department.name === departments[depName as Department].name && "bg-ft-primary-yellow"
                                )}
                                onClick={() => setDepartment(departments[depName as Department])}
                                variant="light"
                            >
                                {/* Split string on capitalized letter first then convert all uppercase */}
                                {depName.split(/(?=[A-Z])/).join(" ").toUpperCase()}
                            </Button>
                        )
                    })}
                </div>
