                ...
                <Dropdown>
                    <DropdownTrigger>
                        ...
                        >
                            ...
                            <CaretDown
                                color="white"
                                className={`flex items-center transition-transform fill-white ${isDropdownOpen ? "transform rotate-180" : ""
                                    }`}
                                onClick={toggleDropdown}
                            />
                        </Button>
                    ...
                    >
                        {[0.5, 1, 1.5, 2].map((speed) => (
                            <DropdownItem textValue={speed.toString()} key={speed}>{speed}x</DropdownItem>
                        ))}
                    </DropdownMenu>
                </Dropdown >
            </div>
