...
const TechnicalProjectPage: React.FC<{ params: { id: string } }> = ({ params }) => {
  ...
  return (
    <div className="w-100 h-auto bg-ft-background">
      <ProjectDescription projectName={projectData.projectName} projectDescription={projectData.description} />
