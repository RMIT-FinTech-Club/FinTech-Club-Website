        ...
        <div className="grid md:grid-cols-1 md:grid-flow-row grid-flow-row-dense max-md:mt-8 mt-28 md:gap-y-32 gap-y-14 md:gap-x-11 md:px-36 px-11 w-full">
          ...
          <div className="grid md:grid-cols-2 md:gap-x-11">
            ...
            <div className="md:mt-0 mt-4 flex flex-col justify-center">
              ...
              <p className="lg:mt-6 md:mt-4 mt-2 text-balance text-justify xl:text-[1.3rem] lg:text-[1rem] md:text-[0.75rem]">
                Aimed at enhancing and refining members’ technical expertise,
                including coding, website & app development, analysis, data
                visualization, design-thinking, etc. These projects provide
                members with a medium of practice and creativity, and an
                opportunity to implement class-learnt theories to real-life
                initiatives.
              </p>
              <div className="flex flex-col items-center mt-6">
                <Button
                  type="button"
                  className="w-fit text-white font-bold rounded-full bg-[#2C305F] lg:text-[1.25rem] md:text-[1rem]"
                >
                  <a href={"/projects/technical"} className="my-4">
                    Explore more
                  </a>
                </Button>
              </div>
          ...
          <div className="grid md:grid-cols-2 md:gap-x-11">
            ...
            <div className="md:mt-0 mt-4 flex flex-col justify-center">
              ...
              <p className="lg:mt-6 md:mt-4 mt-2 text-balance text-justify xl:text-[1.3rem] lg:text-[1rem] md:text-[0.75rem]">
                Aimed at enhancing our members’ marketing skills and bolstering
                FinTech Club’s image, media projects facilitate the creation of
                informative, educational and trendy content that delights our
                club FanPage’s 5000+ people audience. These could include
                short-form reels, medium and long-form videos, infographics,
              ...
              <div className="flex flex-col items-center mt-6">
                <Button
                  ...
                  className="w-fit text-white font-bold rounded-full bg-[#2C305F] lg:text-[1.25rem] md:text-[1rem]"
                >
                  <a href={"/projects/media"} className="my-4">
                    Explore more
                  </a>
                </Button>
              </div>
          ...
          <div className="grid md:grid-cols-2 md:gap-x-11">
            ...
            <div className="md:mt-0 mt-4 flex flex-col justify-center">
              ...
              <p className="lg:mt-6 md:mt-4 mt-2 text-balance text-justify xl:text-[1.3rem] lg:text-[1rem] md:text-[0.75rem]">
                Events are larger-scale/larger-impact projects of FinTech Club.
                These include open academic forums, public workshops, a national
                competition, etc. Events spread the image and ideas of FinTech
                Club, whilst engaging the community to this exciting field!
              </p>
              <div className="flex flex-col items-center mt-6">
                <Button
                  type="button"
                  className="w-fit text-white font-bold rounded-full bg-[#2C305F] lg:text-[1.25rem] md:text-[1rem]"
                >
                  <a href={"/projects/event"} className="my-4">
                    Explore more
                  </a>
                </Button>
              </div>
