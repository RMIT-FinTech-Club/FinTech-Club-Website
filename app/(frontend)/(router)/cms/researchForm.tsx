...
import { getSignedURL } from "@/app/(backend)/api/v1/research/actions";
...
export default function PodcastForm() {
  ...
  const {
    ...
    reset,
    formState: { errors },
  } = useForm<FormInput>({ defaultValues: {} as FormInput });
      ...
      >
        <div className="grid grid-flow-row auto-rows-max gap-7">
          ...
          <div>
            ...
            >
              Upload a pdf file of your research paper here to be downloaded by
              user when they visit this research page
            </p>
          </div>
                ...
                {!file && !fileUrl && (
                  <>
                    ...
                    <p className="mb-2 text-sm text-gray-500 dark:text-gray-400">
                      ...
                      to browse your computer or drag pdf file to this area{" "}
                    </p>
