			...
			<section className="max-w-screen flex justify-center mr-[5vw] items-center">
				...
				<div className="flex flex-col w-[45vw]">
					<div className="flex flex-col items-start">
						<h1
							className={`text-7xl py-2 text-[#DBB968] font-[1000]`}
						>
							FINTECH
						</h1>
						<h2
					...
					<div className="flex flex-col items-center">
						<p
							className={`text-2xl text-justify mt-6 ${fontSans.style}`}
						>
							FinTech Club has been a transformative experience
							for me. As an introvert, I found it challenging to
							make new friends at RMIT. However, joining the
							FinTech Club changed everything. I connected with
							like-minded individuals who shared my passion for
							finance and technology. Winning the "Star-Up"
							competition boosted my confidence and skills, and
							becoming President allowed me to give back to this
							uplifting community.
						</p>
					</div>
				</div>
