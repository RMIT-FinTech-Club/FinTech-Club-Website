                    ...
                    <div className="relative">
                        <div className="absolute rounded-lg pl-[10px] pr-[250px] ">
                            <svg xmlns="http://www.w3.org/2000/svg" width="90" height="82" viewBox="0 0 90 82" fill="none">
                                ...
                                <ellipse cx="13.2273" cy="12.9967" rx="13.2273" ry="12.9967" transform="matrix(-1 0 0 1 75.8172 25.9932)" fill="#2B305E" />
                                <path d="M86.5903 27.4932C85.511 27.4933 84.6812 28.3461 84.6811 29.3428C84.6811 30.3396 85.511 31.1924 86.5903 31.1924C87.6696 31.1924 88.4995 30.3396 88.4995 29.3428C88.4995 28.3461 87.6696 27.4932 86.5903 27.4932Z" fill="#2B305E" stroke="white" stroke-width="3" />
                                <path d="M13.227 26.4932C6.18969 26.4934 0.500412 32.0969 0.500412 38.9903C0.500616 45.8835 6.18981 51.4863 13.227 51.4864C20.2643 51.4864 25.9543 45.8836 25.9545 38.9903C25.9545 32.0968 20.2644 26.4932 13.227 26.4932Z" fill="#DBB968" stroke="#5E5E92" />
                                <path d="M10.3633 62.3043C10.3633 69.4822 16.2853 75.301 23.5906 75.301C30.8958 75.301 36.8178 69.4822 36.8178 62.3043C36.8178 55.1264 30.8958 49.3076 23.5906 49.3076C16.2853 49.3076 10.3633 55.1264 10.3633 62.3043Z" fill="#C9D6EA" />
                                <ellipse cx="3.40909" cy="3.34967" rx="3.40909" ry="3.34967" transform="matrix(-1 0 0 1 19.9089 0)" fill="#DBB968" />
                            </svg>
                        </div>
                        ...
                        <div className=" rounded-[50px] w-[400px] h-[86px] bg-[#DBB968] mt-6 ">
                            <div className="relative">
                                <div className=" absolute rounded-lg pl-[300px] pr-2 pt-1">
                                    <a href="http://linkedin.com/in/dr-binh-nguyen-thanh" target="_blank">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="77" height="77" viewBox="0 0 77 77" fill="none">
                                            ...
                                            <path d="M25.6667 25.6667V25.6992" stroke="#2C305F" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M38.5 51.3334V35.2917" stroke="#2C305F" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round" />
                ...
                <div className="relative bg-[#F9FAFB] pr-5 pl-5 p-[134px] flex flex-col place-items-center">
                    ...
                    <div className="relative">
                        ...
                        <div className="rounded-[50px] w-[400px] h-[86px] bg-[#DBB968] mt-6">
                            <div className="relative">
                                <div className=" absolute rounded-lg pl-[300px] pr-2 pt-1">
                                    <a href="http://linkedin.com/in/huy-pham-5646bb49" target="_blank">
                        ...
                        <div className="rounded-[50px] w-[400px] h-[86px] bg-[#DBB968] mt-6">
                            <div className="relative">
                                <div className=" absolute rounded-lg pl-[300px] pr-[100px] pt-1">
                                    <div className="w-48 h-auto transform transition-transform duration-300 hover:scale-110">
                                    <a href="http://linkedin.com/in/hieu-thai-0a29b6ab" target="blank" >
                                        <svg xmlns="http://www.w3.org/2000/svg" width="77" height="77" viewBox="0 0 77 77" fill="none">
                                            <path d="M12.8333 19.25C12.8333 17.5482 13.5094 15.9161 14.7127 14.7127C15.9161 13.5094 17.5482 12.8333 19.25 12.8333H57.75C59.4518 12.8333 61.0839 13.5094 62.2872 14.7127C63.4906 15.9161 64.1666 17.5482 64.1666 19.25V57.75C64.1666 59.4518 63.4906 61.0839 62.2872 62.2872C61.0839 63.4906 59.4518 64.1666 57.75 64.1666H19.25C17.5482 64.1666 15.9161 63.4906 14.7127 62.2872C13.5094 61.0839 12.8333 59.4518 12.8333 57.75V19.25Z" stroke="#2C305F" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M25.6667 35.2917V51.3334" stroke="#2C305F" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M25.6667 25.6667V25.6992" stroke="#2C305F" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round" />
