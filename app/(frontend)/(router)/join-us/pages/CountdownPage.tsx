...
export default function CountdownPage() {
	...
	return (
		<nav>
			{isMobile ? ( // Container for the whole section
				<div className="flex flex-col">
					{/* Hero Section with Yellow background */}
					<div
						className="relative flex flex-col items-center justify-center rounded-b-[8px]"
						style={{
					...
					>
						<h1
							className={`text-2xl md:text-5xl lg:text-6xl font-bold text-center text-[white] z-10 ${
								isShortHeight ? "mt-8" : ""
							}`}
						>
						...
						<Image
							...
							width={50}
							loading="lazy"
							className="absolute left-[20px] translate-y-32"
						/>
						<Image
							src="/joinUsPage/white-star.svg"
							alt="Big White Star"
							...
							width={50}
							loading="lazy"
							className="absolute right-[1rem] translate-y-48"
						/>
					</div>
