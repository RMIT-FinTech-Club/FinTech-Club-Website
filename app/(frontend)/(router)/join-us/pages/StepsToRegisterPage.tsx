	...
	return (
		<nav>
			{isMobile ? (
				...
				>
					<motion.div
						className="flex flex-col md:grid md:grid-cols-4 lg:flex lg:flex-row justify-center items-center w-full max-w-6xl lg:gap-x-6"
						initial={{ opacity: 0 }}
						...
						<div className="flex flex-col items-center text-center">
							...
							<div>
								<Image
									...
									priority={true}
									loading="eager"
									className="w-[50vw] md:w-[60vw] lg:w-[18vw]"
								/>
							</div>
						</div>
