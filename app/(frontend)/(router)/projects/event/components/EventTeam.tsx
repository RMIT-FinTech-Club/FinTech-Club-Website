...
const EventTeam: React.FC<EventTeamProps> = ({ sectionValue }) => {
    ...
    return (
        <div className="flex flex-col justify-center items-center px-[5vw] py-[10vw]">
            <div className="flex md:justify-between justify-center items-center w-full">
                <div className="text-[2vw] text-deepBlue font-bold uppercase text-center">
            ...
            <div className="flex justify-between md:w-full w-[90vw] mt-[5vw] overflow-hidden rounded-[20px]">
                    ...
                    return (
                        <Link key={index} href={link}>
                            <div
                                ...
                                className={`group relative flex justify-center items-end w-[90vw] md:w-[15vw] aspect-[3/4] overflow-hidden rounded-[20px] cursor-pointer transition-all duration-300`}
                            >
                                <div
                                    className="absolute left-[50%] translate-x-[-50%] top-[10%] w-[150%] aspect-[3/4] bg-cover bg-center bg-no-repeat group-hover:scale-[1.15] transition-all duration-300"
                                    style={{ backgroundImage: `url(${image})` }}
                                ></div>
                                <div className="absolute w-[14vw] h-[4vw] left-[0.5vw] bottom-[0.5vw] bg-white rounded-[15px] flex flex-col p-[0.5vw]">
                                    <div className="w-full text-[1vw] text-deepBlue font-bold text-center leading-[1.5vw] group-hover:brightness-200 transition-all duration-300">
                                        {name}
                                    </div>
                                    <div className="w-full text-[1vw] text-gold font-semibold text-center leading-[1.5vw]">
                                        {role}
                                    </div>
                                </div>
                            </div>
