		...
		<nav>
			{isMobile ? (
				<section className="pt-20">
					<h1
						className="flex justify-center text-[3rem] ml-[1.5rem] mb-[1.5rem] text-[#0D1742] !font-extrabold drop-shadow-[0_4px_4px_rgba(255,204,102,0.6)]"
				...
				<section className="pt-20">
					...
					<div className="flex justify-between">
						<div className="w-[100vw] h-fit min-h-[35vh] bg-[#F9FAFB] py-20 relative flex items-end">
							<PartnersCircle
								items={items}
								handleClick={handleClick}
								circleRef={circleRef}
							...
							<div className="absolute z-30 left-[90rem] top-[.5rem] rotate-[-5deg]">
								<svg
									xmlns="http://www.w3.org/2000/svg"
									width="30"
									height="30"
