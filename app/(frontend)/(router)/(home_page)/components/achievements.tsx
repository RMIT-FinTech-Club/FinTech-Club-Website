...
const Achievements = () => {
	...
	return (
		<nav>
			{isMobile ? (
				<section className="bg-[#F9FAFB] w-[100vw] pb-[2rem] relative">
					<div className="pl-[2rem] md:pl-[5rem]">
						<h2 className="text-[2.5rem] md:text-[5rem] font-bold text-[#2C305F] [text-shadow:_0_3px_4px_rgba(0,0,0,0.5)]">
							Achievement
						</h2>
						<h3 className="text-[1.5rem] md:text-[2rem] font-bold text-[#DCB968] leading-[6rem] [text-shadow:_0_1px_1px_rgba(0,0,0,0.5)]">
							Best Club of Semester
						</h3>
						<p className="md:text-[1.5rem] text-[1.5rem] font-bold text-[#5E5E92]">
							5 times
						</p>
						<div className="pt-10">
							<div className="relative md:w-[300px] md:pl-[20rem] ml-24 min-w-[200px] w-[200px] flex justify-center items-center">
								{cards.map((card) => (
									<CARD_STACK
										key={card.id}
										id={card.id}
					...
					<div className="pt-[20rem] pl-10">
						<div>
							<h3 className="text-[1.5rem] font-bold text-[#DCB968] leading-[6rem] [text-shadow:_0_1px_1px_rgba(0,0,0,0.5)]">
								Innovation Award
							</h3>
							<p className="text-[1.5rem] font-bold text-[#5E5E92]">2023</p>
						</div>
						<Image
							src="https://d2prwyp3rwi40.cloudfront.net/home/achievement/InnovationAward-2023.png"
							className="ml-[2rem] pt-10 object-fill w-[15rem] h-[40vh] rounded-lg shadow-lg hover:scale-105 transition-transform duration-200"
							width={100}
							height={150}
					...
					<script>​…​</script>​
					<div className="pl-[2rem] mt-[2rem]">
						<h3 className="pt-[2rem] text-[1.5rem] font-bold text-[#DCB968] leading-[3rem] [text-shadow:_0_1px_1px_rgba(0,0,0,0.5)]">
							Publicity Award
						</h3>
						<p className="mt-0 text-[1.5rem] font-bold text-[#5E5E92]">2024</p>
						<div className="flex flex-col md:flex-row gap-[7rem] relative">
							<Image
								...
								className="object-cover md:w-[40rem] pt-10 w-[20rem] rounded-lg shadow-lg hover:scale-105 transition-transform duration-200"
								width={200}
								height={150}
								alt="Publicity Award"
								fetchPriority="high"
