...
const HeroSection = () => {
	...
	return (
		<nav>
			{isMobile ? (
				<div className="w-screen bg-[#F9FAFB] lg:py-12 flex-col justify-start items-center mt-10 md:p-20 gap-6 md:gap-12 flex">
					<div className=" justify-start items-center gap-6 md:gap-[60px] flex flex-col md:flex-row ">
						<div className="content w-full md:w-[45vw] h-full relative">
							...
							<h2 className="">What is</h2>
							<h2 className="text-[#000A64] !font-black uppercase mt-[0.75rem] mb-[1.25rem]">
								<span className="text-[#DCB968]">Fin</span>Tech Club?
							</h2>

							<p className="leading-relaxed text-justify w-[300px] h-[350px] text-[1rem] md:text-[1.25rem]">
								We are the first ever student-led Financial Technology
								initiative in Vietnam. Founded in early 2020, RMIT FinTech Club
								aims to unite students across diverse degree programs and offer
								valuable insights into the dynamic realm of Financial
								Technology. Through a wide range of initiatives, we empower our
								members with the necessary skills, mindset, and confidence to
								engage in the fast-growing FinTech industry.
							</p>
						...
						<div className="w-full md:w-[40vw] rounded-xl relative flex flex-col items-center justify-center">
							<div className="mt-4 flex flex-col justify-center w-full">
								...
								<div className="flex flex-row mt-2 justify-between items-center">
									<div className="bg-[#F8DA92] p-3 text-center w-[25vw] border-0">
										Projects
									</div>
									<div className="bg-[#F8DA92] p-3 text-center w-[20vw] border-0">
										Events
									</div>
									<div className="bg-[#F8DA92] p-3 text-center w-[30vw] border-0">
										Workshops
									</div>
								</div>

								<div className="flex flex-row mt-2 justify-center gap-4 items-center">
									<div className="bg-[#F8DA92] p-3 text-center w-[40vw] border-0">
										Competitions
									</div>
									<div className="bg-[#F8DA92] p-3 text-center w-[25vw] border-0">
										Training
					...
					<div className="flex-col md:flex-row justify-between items-center flex w-full h-fit"></div>
				</div>
			) : (
				/*desktop*/
						...
						<div className="w-full md:w-[40vw] rounded-xl relative flex flex-col items-center justify-center">
							...
							<div className="mt-4 flex flex-col justify-center w-full">
								...
								<div className="flex flex-row mt-2 justify-between items-center">
									...
									<div className="bg-[#F8DA92] p-3 text-center md:w-[15vw] w-[11vw] border-0">
										Workshops
									</div>
								</div>

								<div className="flex flex-row mt-2 justify-center gap-4 items-center">
									<div className="bg-[#F8DA92] p-3 text-center md:w-[18vw] w-[11vw] border-0">
										Competitions
									</div>
									<div className="bg-[#F8DA92] p-3 text-center w-[11vw] border-0">
										Training
