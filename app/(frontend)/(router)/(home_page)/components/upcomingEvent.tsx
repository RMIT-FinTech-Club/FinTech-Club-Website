	...
	const renderContent = () => {
		...
		return (
			<nav>
				{isMobile ? (
					<section>
						<div className="h-[100vh] w-[100vh] relative">
								...
								return (
									<div
										...
										className={clsx(
											...
											"grid place-items-center h-[80vh] w-[80vw] border-bluePrimary border-[0.5vh] rounded-[2vw] p-[2vh] bg-blueSlate"
										)}
										onClick={() => {
									...
									>
										...
										<p className="text-[1rem] pr-24 leading-7 text-yellowSand uppercase text-center font-bold">
											{ev.name}
										</p>

										<div
											className="relative mr-20 w-[30vh] h-[25vh] rounded-[3vh] p-[1vh]"
											style={{
												background:
										...
										<div className="h-[15vh] flex justify-center mr-12">
											<div
												className="w-[10vh] h-full aspect-square rounded-[3vh] p-[3vh]"
												style={{
													background:
														"linear-gradient(to bottom, #C9D6EA, #DBB968)",
												}}
											>
												<div className="bg-ft-primary-yellow-50 w-[5vh] h-full rounded-[3vh] flex flex-col justify-center items-center">
											...
											>
												<div className="bg-white w-[10vh] h-full rounded-[0.5vh] flex flex-wrap justify-around items-center">
													<p className="text-[0.5rem] leading-[4vh] font-bold text-ft-primary-blue-50 uppercase">
														Location
													</p>
													<p className="text-[0.6rem] leading-[2vh] font-medium text-center text-bluePrimary">
														{ev.location}
													</p>
												</div>
											</div>
											<div
												className="w-[10vh] h-full aspect-square rounded-[3vh] p-[1.5vh] ml-[1vw]"
												style={{
													background:
														"linear-gradient(to bottom, #C9D6EA, #DBB968)",
												}}
											>
												<div className="bg-ft-primary-yellow-50 w-[5vh] h-full rounded-[3vh] flex flex-col justify-center items-center">
													...
													<p className="text-[0.85rem] leading-[3vh] font-medium text-center">
														{ev.mode}
													</p>
												</div>
											</div>
										...
										<Link
											href={`/events/${ev._id}`}
											className="h-fit w-fit rounded-[3.5vh] py-[1vh] px-[1.5vw] cursor-pointer"
											style={{
												background:
													"linear-gradient(to bottom, #C9D6EA, #DBB968)",
											}}
		...
		<nav>
			{isMobile ? (
				<div className="h-fit w-[100vw] py-6 relative flex flex-col items-center">
					{/* Header */}
					<div className="h-[max-content] w-[max-content] relative mx-auto mt-[2vh] mb-[9vh]">
						<p className="pb-5 text-[7vw] text-bluePrimary uppercase font-extrabold text-center">
							UPCOMING EVENTS
						</p>
						<div
